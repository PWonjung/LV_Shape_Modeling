...
label = 'oasis_normal_lv'
def process_input(data_path, sub_id):
    command = f"python ../../optim/lv_train.py --data_path {data_path} --tag {label}  --learning_rate 0.0005 --sub_id {sub_id} --gpu 0 --lda 1 3 2000 500 100 1 1"

...
label = 'adni_demented_tex_4'
def process_input(data_path, sub_id):
    command = f"python ../../optim/hippo_lv_tex_train.py --data_path {data_path} --tag {label}  --learning_rate 0.0005 --sub_id {sub_id} --gpu 1 --lda 2 2 50 10 10 1 1"
...
def main():
    ...
    filelist = glob.glob(f"/root/LV/LV/2502LV/ADNI/demented_mid_tgt/*.pkl")
    filelist = filelist
    print(filelist)

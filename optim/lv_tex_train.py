...
from models.loss import lv_tex_criterion
...
def main(args):
    ...
    for epoch in tqdm(range(args.epoch)):
        ...
        loss, log = lv_tex_criterion(verts, lv_target, hippo_target,tex1_target, tex2_target, tex3_target, lv_tri, hippo_tri, tri1, tri2, tri3, args.lda)
